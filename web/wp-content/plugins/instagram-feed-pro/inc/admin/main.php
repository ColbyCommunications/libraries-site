...
function sbi_welcome_screen_new_content() {
    ...
    <div class="wrap about-wrap sbi-welcome">
        ...
        <div class="changelog">
            <h3><?php _e('Sort Posts by Likes'); ?></h3>
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-sort-likes.png'; ?>" style="padding: 0px; background: white;">
                </div>

                <div class="sbi-feature-section-content">
                    <p><?php _e("Want to show off your most popular posts first? You can now use our sorting feature to show the most liked posts first in your feed."); ?></p>

                    <h4><?php _e("Directions"); ?></h4>
                    <ul>
                        <li><?php echo sprintf( __( 'Make sure your account is connected as a %sbusiness account%s.', 'instagram-feed' ), '<a href="https://smashballoon.com/instagram-business-profiles/" target="_blank" rel="noopener">', '</a>' ); ?></li>
                        <li><?php _e( 'Go to Instagram Feed > Customize > Posts. Change the "Sort Photos By" setting to "likes".', 'instagram-feed' ); ?></li>
                        <li><?php _e( 'Alternatively you can use sortby=likes in your shortcode.', 'instagram-feed' ); ?></li>
                    </ul>
        ...
        <div class="changelog">
            <h3><?php _e('Offset the First Posts'); ?></h3>
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-offset.png'; ?>" style="padding: 0px; background: white;">
                </div>

                <div class="sbi-feature-section-content">
                    <p><?php _e("Some use cases call for hiding the first few posts in a feed. You can now use our post offset feature to do just that."); ?></p>

                    <h4><?php _e("Directions"); ?></h4>
                    <ul>
                        <li><?php _e( 'Go to Instagram Feed > Customize > Posts. Change the "Offset" setting to the number of posts you would like to skip in the beginning of your feed.', 'instagram-feed' ); ?></li>
                        <li><?php _e( 'Alternatively you can use offset=(number) in your shortcode.', 'instagram-feed' ); ?></li>
                    </ul>
        ...
        <div class="changelog">
            <h3><?php _e('Admin Notifications and Email Alerts for Down Feeds'); ?></h3>
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-site-health.png'; ?>" style="padding: 0px; background: white;">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-site-health-frontend.png'; ?>" style="padding: 0px; background: white; margin-top: 10px;">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-site-health-email.png'; ?>" style="padding: 0px; background: white; margin-top: 10px;">
                </div>

                <div class="sbi-feature-section-content">
                    <p><?php _e("The results of our recent customer survey told us that we need to do better at letting you know when there is a problem with your feeds. As part of our improvements, when there is a critical error with one of the feeds you'll receive various notifications: in the dashboard, on the front-end of your site if logged-in as an admin, a notice in the WordPress 'Site Health' tool, and also an email alert sent once per week if the issue hasn't been resolved."); ?></p>

                    <h4><?php _e("Directions"); ?></h4>
                    <p><?php _e('These noticiations are enabled by default, but can be disabled using the following settings:'); ?> <em><?php _e('Instagram Feed > Customize > Advanced > Misc > "Disable Admin Error Notice" and "Feed Issue Email Report".'); ?></em></p>

                    <h4><?php _e("Errors that will trigger the notices:"); ?></h4>
                    <ul>
                        <li><?php _e("Your access token has expired or has been invalidated"); ?></li>
                        <li><?php _e("Your website server is unable to connect to Instagram's API"); ?></li>
                        <li><?php _e("Your feed is unable to update due to an error with Instagram's API"); ?></li>
                    </ul>
        ...
        <div class="changelog">
            <h3><?php _e('About Us Page'); ?></h3>
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-about-us.jpg'; ?>" style="padding: 0px; background: white;">
                </div>

                <div class="sbi-feature-section-content">
                    <p><?php _e("Did you ever want to know who's behind the Instagram Feed plugin? We've added an about page to tell you a little about us as well as provide some helpful docs to help you get started. You can even install our other plugins and those we recommend right from the page!"); ?></p>
                    <p><?php echo sprintf( __("Visit %sthe About Us page%s to check it out."), '<a href="'.admin_url( 'admin.php?page=sb-instagram-feed-about' ).'">', '</a>' ); ?></p>
                </div>
            </div>
        </div>

        <div class="changelog">
            <h3><?php _e('Instagram Feed Gutenberg Block'); ?></h3>
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-block.png'; ?>" style="padding: 0px; background: white;">
                </div>

                <div class="sbi-feature-section-content">
                    <p><?php _e("Easily add your feed to a page or post using the block editor and our new Instagram Feed Gutenberg Block. Add shortcode settings to an input field to customize each feed individually."); ?></p>
        ...
        <div class="changelog">
            <h3><?php _e('Support for new Instagram API for Personal Accounts'); ?></h3>
            <?php
            ...
            if ( ! empty( $personal_accounts_that_need_updating ) ) {
	            ...
	            if ( sbi_is_after_deprecation_deadline() ) {
		            $error = '<p><b>' . sprintf( __( 'Action Needed: The account for %s needs to be reconnected.', 'instagram-feed' ), $user_string ) . '</b><br>' . __( 'As of June 1, 2020, Instagram no longer supports this type of connected account. Go to the Instagram Feed Settings page and click the big blue button to reconnect.', 'instagram-feed' );
	            } else {
		            $error = '<p><b>' . sprintf( __( 'Action Needed: The account for %s needs to be reconnected.', 'instagram-feed' ), $user_string ) . '</b><br>' . __( 'Due to upcoming Instagram platform changes on June 1, 2020, some Instagram accounts will need to be reconnected in the plugin to avoid disruption to your feeds.', 'instagram-feed' );
	            }
            ...
            <div class="sbi-notice">
		        <?php echo $error; ?>
                <p>
                   <a href="<?php echo $url; ?>" class="button-primary"><i class="fa fa-cog" aria-hidden="true"></i>&nbsp; Reconnect on Settings Page</a>
                </p>
            </div>
            ...
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-token.jpg'; ?>" style="padding: 0px; background: white; margin-bottom: 10px;">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-reconnect.png'; ?>" style="padding: 0px; background: white;">
                </div>

                <div class="sbi-feature-section-content">
                    <p><?php _e("On June 1, 2020, Instagram will be deprecating their old API which is used to display feeds from Personal Instagram accounts. Our plugin supports the new Instagram API but requires you to reconnect any Personal Instagram accounts in the plugin for them to continue working."); ?></p>

                    <h4><?php _e("To reconnect your Personal accounts:"); ?></h4>
                    <ol>
                        <li><?php _e("Go to the <a href='".$url."'>Instagram Feed Settings page</a>"); ?></li>
                        <li><?php _e("Click on the big blue button labeled \"Connect an Instagram Account\""); ?></li>
                        <li><?php _e("Choose to connect as \"Personal\""); ?></li>
                        <li><?php _e("Log in to the Instagram account that you would like to reconnect and authorize the plugin."); ?></li>
                    </ol>
                    <p style="font-size: 12px;"><?php _e('<b>Note:</b> If all of your connected accounts are already connected as "Business" accounts then no action is required.'); ?></p>
                </div>
            </div>
        </div>

        <div class="changelog">
            <h3><?php _e('Display "tagged" feeds'); ?></h3>
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-tagged.jpg'; ?>" style="padding: 0px; background: white;">
                </div>

                <div class="sbi-feature-section-content">
                    <p><?php _e("Display a feed of posts that your account has been tagged in. Increase your audience's engagement with your Instagram account by displaying tagged posts on your website."); ?></p>

                    <h4><?php _e("Directions"); ?></h4>
                    <p><?php _e( "Tagged feeds require a connected business account that has given the Smash Balloon app permission to manage comments (the manage comments permission is part of the same permission to get information about tagged photos). If you have previously connected a business account, you'll need to reconnect it using the big blue button on the \"Configure\" tab and then approve the Smash Balloon app to manage comments." ); ?></p>
        ...
        <div class="changelog">
            <h3><?php _e('Faster and more efficient'); ?></h3>
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-performance.png'; ?>" style="padding: 0px; background: white;">
                </div>

                <div class="sbi-feature-section-content">
                    <p><?php _e("We've rebuilt the plugin from the ground up with a focus on performance and reliability. Your feed HTML is now generated using PHP and loaded along with the rest of your page, providing a performance boost and allowing for even more customization and extensibility in future updates."); ?></p>
                </div>
            </div>
        </div>

        <div class="changelog">
            <h3><?php _e('Store and use local images in you feed'); ?></h3>
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-local.png'; ?>" style="padding: 0px; background: white;">
                </div>

                <div class="sbi-feature-section-content">
                    <p><?php _e("By default a local copy of images in your feed are stored on your server, removing the reliance on Instagram's CDN as well as helping with GDPR compliance. Local images can also help optimize the resolution of images in your feed and avoid redirects that sometimes come from using URL's provided by Instagram."); ?></p>
                    <p><?php _e("This setting is enabled by default but can be disabled in the following location: Instagram Feed > Customize > Advanced > Misc > Image Resizing"); ?></p>
                </div>
            </div>
        </div>

        <div class="changelog">
            <h3><?php _e('Update feeds in the background'); ?></h3>
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-caching.png'; ?>" style="padding: 0px; background: white;">
                </div>

                <div class="sbi-feature-section-content">
                    <p><?php _e("All calls to the Instagram API to get new posts are now done server-side. To keep your page load times speedy, you can enable the setting on the \"Configure\" tab to cache posts using WordPress' background cron system."); ?></p>
                    <p><?php _e("Local images can also created and stored during the background process to make sure a local version of the image is always served to your visitors."); ?></p>
                </div>
            </div>
        </div>

        <div class="changelog">
            <h3><?php _e('View your Instagram story on your site'); ?></h3>
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-story.png'; ?>" style="padding: 0px; background: white;">
                </div>

                <div class="sbi-feature-section-content">
                    <p><?php _e("Your site's visitors can now view your Instagram story in a lightbox by clicking on the avatar in a user feed header. If a story is available, you'll see a colored border around the avatar."); ?></p>

                    <div class="sbi-feature-section-content" style="width: 96%;">
                        <p style="max-width: 100%;"><?php _e("We've made some other improvements and fixes too, such as:"); ?></p>

                        <ul>
                            <li>Connecting multiple unique business accounts (use separate connected Facebook pages) will allow you to use more than 30 hashtags in your feeds per week.</li>
                            <li>New capability "manage_instagram_feed_options" to allow non-admins to manage Instagram Feed settings pages.</li>
                            <li>See the full change log <a href="https://smashballoon.com/instagram-feed/change-log/?utm_campaign=instagram-pro&utm_source=welcome&utm_medium=changelog" target="_blank">here</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <p class="sbi-footnote"><i class="fa fa-heart"></i><?php echo sprintf( __( "Your friends %s", 'instagram-feed' ), '@ <a href="https://smashballoon.com/?utm_campaign=instagram-pro&utm_source=wlecome&utm_medium=friends" target="_blank">Smash Balloon</a>' ); ?>

			<?php $disable_welcome = get_user_meta(get_current_user_id(), 'sbi_disable_welcome', true);

			if ( empty($disable_welcome)) : ?>
                <a class="sbi-redirect-disable" href="JavaScript:void(0);"><?php _e( "Disable welcome page", 'instagram-feed' ); ?></a>
			<?php endif; ?>
        </p>
    ...
    <div class="wrap about-wrap sbi-welcome">
        ...
        <div class="sbi-123">
            <div class="changelog">
                <div class="feature-section">
                    <div class="sbi-feature-section-media">
                        <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-license.png'; ?>">
                    </div>
            ...
            <div class="changelog">
                <div class="feature-section">
                    <div class="sbi-feature-section-media">
                        <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-token.jpg'; ?>">
                    </div>
                    <div class="sbi-feature-section-content">
                        <h3><span class="sbi-big-text">2</span><?php _e("Connect an Instagram Account", 'instagram-feed' ); ?></h3>
            ...
            <div class="changelog">
                <div class="feature-section">
                    <div class="sbi-feature-section-media">
                        <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-type.png'; ?>">
                    </div>
                    <div class="sbi-feature-section-content">
                        <h3><span class="sbi-big-text">3</span><?php _e("Select your Feed Type", 'instagram-feed' ); ?></h3>
                        <p><?php _e("Choose to display posts from a user account, hashtag, or both.", 'instagram-feed' ); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="changelog">
                <div class="feature-section">
                    <div class="sbi-feature-section-media">
                        <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-shortcode.png'; ?>">
                    </div>
                    <div class="sbi-feature-section-content">
        ...
        <div class="changelog">
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-multiple.jpg'; ?>">
                </div>
                <div class="sbi-feature-section-content">
        ...
        <div class="changelog">
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-customize.png'; ?>">
                </div>
                <div class="sbi-feature-section-content">
        ...
        <div class="changelog">
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <a href='admin.php?page=sbi-top&amp;tab=support'><img src="<?php echo SBI_PLUGIN_URL .  'img/welcome-support.png'; ?>"></a>
                </div>
                <div class="sbi-feature-section-content">
        ...
        <p class="sbi-footnote"><i class="fa fa-heart"></i><?php echo sprintf( __( "Your friends %s", 'instagram-feed' ), '@ <a href="https://smashballoon.com/?utm_campaign=instagram-pro&utm_source=welcome&utm_medium=friends" target="_blank">Smash Balloon</a>' ); ?></p>
...
function sbi_welcome_header(){ ?>
    ...
    <div id="sbi-header">
        ...
        <a href="https://smashballoon.com/?utm_campaign=instagram-pro&utm_source=welcome&utm_medium=header" class="sbi-welcome-image" title="Your friends at Smash Balloon" target="_blank">
            <img src="<?php echo SBI_PLUGIN_URL .  'img/balloon.png'; ?>" alt="Instagram Feed Pro">
        </a>
                    ...
                    <td>
                        ...
                        <p style="font-size: 13px;">
                            ...
                            <span class="sbi_tooltip">
                                    ...
                                    &bull;&nbsp; <a href='https://smashballoon.com/contact/?utm_campaign=instagram-pro&utm_source=license&utm_medium=upgrade' target='_blank'><?php _e( 'Contact us directly', 'instagram-feed' ); ?></a>
                                </span>
    ...
    <?php } // End Configure tab ?>
            ...
            <table class="form-table sbi-expandable-options">
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <span class="sbi_note"><?php _e("User feeds only", 'instagram-feed'); ?></span>
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <span class="sbi_note"><?php _e('Business accounts only', 'instagram-feed'); ?></span>
	    ...
	    <?php if( $sbi_active_tab == 'customize-posts' ) { //Start Customize Posts tab ?>
            ...
            <div>
                ...
                <span class="sbi_tooltip"><?php echo sprintf( __("Instagram is deprecating their old API for Personal accounts on June 1, 2020. The plugin supports their new API, however, some features (such as this one) are not yet available in their new API. If you require this feature then it is available if you convert your Instagram account from a Personal to a Business account by following %s.", 'instagram-feed'), '<a href="https://smashballoon.com/instagram-business-profiles/" target="_blank">these directions</a>' ); ?></span>
                </p>
            </div>
	    ...
	    <?php if( $sbi_active_tab == 'customize-moderation' ) { //Start Customize Moderation tab ?>
            ...
            <p>
                ...
                <span class="sbi_tooltip" style="width: 100%;"><?php _e("Instagram is deprecating their old API for Personal accounts on June 1, 2020. The plugin supports their new API, however, some features (such as this one) are not yet available in their new API. For this reason, it is now only possible to filter posts by the caption and not the comments.", 'instagram-feed'); ?></span>
            </p>
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <a class="sbi_tooltip_link" href="JavaScript:void(0);"><?php _e("What is this?", 'instagram-feed'); ?></a>
                        <p class="sbi_tooltip"><b><?php _e('Visual Moderation Mode', 'instagram-feed' ); ?></b><br /><?php echo sprintf( __("This adds a button to each feed that will allow you to hide posts, and create white lists from the front end using a visual interface. Visit %s for details", 'instagram-feed'), '<a href="https://smashballoon.com/guide-to-moderation-mode/" target="_blank">' . __('this page', 'instagram-feed' ) . '</a>' ); ?></p>
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="sbi_tooltip_link" href="JavaScript:void(0);"><?php _e('What does this mean?', 'instagram-feed'); ?></a>
                        <p class="sbi_tooltip"><?php _e( "Character Limits for captions are adjusted for use of new line or %s html. Disable this setting to always use the true character limit.", 'instagram-feed' ); ?></p>
                    </td>
                </tr>
                <tr>
