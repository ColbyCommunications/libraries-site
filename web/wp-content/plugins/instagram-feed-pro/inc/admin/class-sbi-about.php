	...
	protected function output_getting_started() {
		...
		<div class="sbi-admin-about-section sbi-admin-about-section-first-form" style="display:flex;">
			...
			<div class="sbi-admin-about-section-first-form-text">
                ...
                <ul class="list-plain">
                    <li>
                        <a href="https://smashballoon.com/display-multiple-instagram-feeds/?utm_campaign=instagram-pro&utm_source=gettingstarted&utm_medium=multiplefeeds" target="_blank" rel="noopener noreferrer">
							<?php esc_html_e( 'How to Display Multiple Feeds', 'instagram-feed' ); ?>
                        </a>
                    </li>
                    <li>
                        <a href="https://smashballoon.com/get-access-token-from-another-account/?utm_campaign=instagram-pro&utm_source=gettingstarted&utm_medium=differentaccounts" target="_blank" rel="noopener noreferrer">
							<?php esc_html_e( 'Connect a Different Account', 'instagram-feed' ); ?>
                        </a>
                    </li>
                    <li>
                        <a href="https://smashballoon.com/differences-between-an-instagram-personal-and-business-account/?utm_campaign=instagram-pro&utm_source=gettingstarted&utm_medium=personalvbusiness" target="_blank" rel="noopener noreferrer">
        ...
        <div class="sbi-admin-about-section sbi-admin-about-section-squashed sbi-admin-about-section-post sbi-admin-columns">
            ...
            <div class="sbi-admin-column-80">
                ...
                <a href="https://smashballoon.com/instagram-feed/free/?utm_campaign=instagram-pro&utm_source=gettingstarted&utm_medium=readsetup" target="_blank" rel="noopener noreferrer" class="sbi-admin-about-section-post-link">
		...
		<div class="sbi-admin-about-section sbi-admin-about-section-squashed sbi-admin-about-section-post sbi-admin-columns">
			...
			<div class="sbi-admin-column-80">
                ...
                <a href="https://smashballoon.com/instagram-feed/docs/errors/?utm_campaign=instagram-pro&utm_source=gettingstarted&utm_medium=readerrordoc" target="_blank" rel="noopener noreferrer" class="sbi-admin-about-section-post-link">
					<?php esc_html_e( 'Read Documentation', 'instagram-feed' ); ?><i class="fa fa-external-link" aria-hidden="true"></i>
				</a>
			</div>
		</div>
		...
		return array(
			'custom-facebook-feed/custom-facebook-feed.php' => array(
				...
				'pro'  => array(
					...
					'desc' => esc_html__( 'Custom Facebook Feed makes displaying your Facebook posts easy. Keep your site visitors informed and increase engagement with your Facebook page by displaying a feed on your website.', 'instagram-feed' ),
					'url'  => 'https://smashballoon.com/custom-facebook-feed/?utm_campaign=instagram-pro&utm_source=cross&utm_medium=cffinstaller',
					'act'  => 'go-to-url',
				),
			),
			...
			'custom-twitter-feeds/custom-twitter-feed.php' => array(
				...
				'pro'  => array(
					...
					'desc' => esc_html__( 'Custom Twitter Feeds is a highly customizable way to display tweets from your Twitter account. Promote your latest content and update your site content automatically.', 'instagram-feed' ),
					'url'  => 'https://smashballoon.com/custom-twitter-feeds/?utm_campaign=instagram-pro&utm_source=cross&utm_medium=ctfinstaller',
					'act'  => 'go-to-url',
				),
			),
