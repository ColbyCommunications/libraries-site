 ...
 */
function colby_openhours_get_hours_text( $id, $viewall = false ) {
	...
	if ( false === $viewall ) {
		...
		return colby_openhours_fix_hours_text( $todays_hours );
	}
...
<?php
	...
	return colby_openhours_fix_hours_text( ob_get_clean() );
}
 ...
 */
function colby_openhours_fix_hours_text( $todays_hours ) {
 ...
 */
function colby_openhours_set_atts( $input, $defaults, $output = [] ) {
	if ( empty( $defaults ) ) {
		return $output;
	}
	...
	return colby_openhours_set_atts( $input, $defaults, $output );
}
