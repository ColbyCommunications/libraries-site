...
(function ($) {
  ...
  var AwsAccordion = function AwsAccordion(elem, options) {
    ...
    methods = {
      ...
      calcBordWidthHor: function calcBordWidthHor() {
        var borRight, borLeft;
      ...
      calcDivWidthHor: function calcDivWidthHor() {
      ...
      matchQueryMedia: function matchQueryMedia() {
      ...
      responsiveAction: function responsiveAction(mq) {
    ...
    core = {
      ...
      //Set Visual Attributes for Accordeons
      setAttrs: function setAttrs() {

        //define i for for and mediaquerie to obtain max-width and/or min-width value defined by user 
        var i, mq, numberHeight, iconHeight, h1Height, h1HeightIe, currentHeight, currentWidth, windowHeight, windowWidth;
      ...
      // Slide Content
      slideContent: function slideContent(ev) {
      ...
      // Slide Up
      animateSlideUp: function animateSlideUp(selector) {
      ...
      // Slide Down
      animateSlideDown: function animateSlideDown(selector) {
      ...
      // Slide Right
      animateSlideRight: function animateSlideRight(selector) {
      ...
      // Slide Right
      animateSlideLeft: function animateSlideLeft(selector) {
      ...
      resetSlideContent: function resetSlideContent() {
