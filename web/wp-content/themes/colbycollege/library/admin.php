...
function colby_rss_dashboard_widget()
{
 ...
 // fallback message
   ...
   foreach ($items as $item): ?>
		...
		<?php endforeach;
  ?>
	<div><strong><a href="https://colby.edu/weboffice">Web Requests and Tutorials ></a><strong></div>
	<?php
}
...
if (isset($_GET['activated']) && is_admin()) {
 ...
 if ($samplePage == null && $page_count->publish == 1) {
 ...
 if ($frontPage == null && $page_count->publish < 2) {
