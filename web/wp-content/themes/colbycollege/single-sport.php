...
get_header();?>
     ...
     if ($selecYear > 2005 || $season == 'all') {
      ...
      // Spring sport $startDate = 1/1/(YEAR+1) $endDate 6/30/(YEAR+1)
       ...
       if ($queryPosts->post_count > 0) {
        ...
        if ($season == 'all') {
         echo '<a href="https://colby.edu/athletics/sport/' . $pagename . '/?view=archives">View full archives ></a>';
        }

       } else {
        echo '<em>No news was found for this team/season. Please <a href="https://colby.edu/athletics/sport/' . $pagename . '/?view=archives">browse the archives for older news</a>.</em>';
       }
 ...
 echo do_shortcode('[athleticsSlideshow abstract = "true" sport="' . $colbyAthleticsPlugin->sportObject->sportname . '"]');
   ...
   ?>
												...
												<a href="https://colby.edu/athletics/sport/<?php echo $pagename; ?>/?view=archives&season=all&type=news">More news ></a>
...
?>
					...
					<div class="widget">
						<ul id="team-navigation">
		    				<li class="<?php echo ($view == 'home' ? 'selected' : ''); ?>"><a href="https://colby.edu/athletics/sport/<?php echo $tag[0]->slug; ?>/"><?php echo $sport_title ?> Home</a></li>
